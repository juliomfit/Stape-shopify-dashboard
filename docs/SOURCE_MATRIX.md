...
| True Performance | `/attribution` | Shopify gn_* first-touch. Source tab = raw `utm_source`. GA4 session source is a labeled comparison only. | Spend labeled platform/paste. Channel ROAS = gn_* revenue ÷ platform spend. Never Ads Manager attribution. |
