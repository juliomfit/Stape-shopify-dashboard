        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <article className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            ...
            <div className="mt-2">
              ...
              <Detail label="Meta campaign ID" value={order.firstTouch.metaCampaignId} />
              <Detail label="Meta adset ID" value={order.firstTouch.metaAdsetId} />
              <Detail label="Meta ad ID" value={order.firstTouch.metaAdId} />
