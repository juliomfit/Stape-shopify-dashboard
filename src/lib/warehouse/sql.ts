...
WITH stg AS (
  SELECT
    ...
    COALESCE(NULLIF(utm_source, ""), NULLIF(REGEXP_EXTRACT(page_location, r"[?&]utm_source=([^&]+)"), "")) AS raw_source,
    COALESCE(NULLIF(utm_medium, ""), NULLIF(REGEXP_EXTRACT(page_location, r"[?&]utm_medium=([^&]+)"), "")) AS raw_medium,
    COALESCE(NULLIF(utm_campaign, ""), NULLIF(REGEXP_EXTRACT(page_location, r"[?&]utm_campaign=([^&]+)"), "")) AS raw_campaign,
    COALESCE(NULLIF(utm_content, ""), NULLIF(REGEXP_EXTRACT(page_location, r"[?&]utm_content=([^&]+)"), "")) AS raw_content,
    COALESCE(NULLIF(utm_term, ""), NULLIF(REGEXP_EXTRACT(page_location, r"[?&]utm_term=([^&]+)"), "")) AS raw_term,
